        ...
        function setThemeColor(color) {
            if (color === "red") {
                ...
                $(".inside_box,.TwoColorBtn,#startSlot").css({
                    ...
                    background:
                        "linear-gradient(0deg, rgba(153,255,161,1) 0%, rgba(242,245,245,1) 100%)",
                });
                ...
                $(".inside_box,.TwoColorBtn,#startSlot").css({
                    ...
                    background:
                        "linear-gradient(0deg, rgba(255,191,172,1) 0%, rgba(236,236,236,1) 100%)",
                });
                ...
                $(".inside_box,.TwoColorBtn,#startSlot").css({
                    ...
                    background:
                        "linear-gradient(0deg, rgba(174,138,250,1) 5%, rgba(226,213,242,1) 100%)",
                });
                ...
                $(".inside_box,.TwoColorBtn,#startSlot").css({
                    ...
                    background:
                        "linear-gradient(0deg, rgba(228,156,225,1) 0%, rgba(254,243,254,1) 100%)",
                });
