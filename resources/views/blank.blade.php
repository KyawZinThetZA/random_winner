    ...
    <div>
        ...
        <div class="flex justify-between items-center">
            <a href="{{ route('Upload') }}" class="flex justify-end mx-5">
                <button class="w-[30px] h-[30px] rounded-full TwoColorBtn uppercase text-lg tracking-wider text-slate-500"><i
                ...
                <form action="{{ route('storeBlank') }}" method="POST">
                    ...
                    <div class="flex justify-end">
                        <a href="{{ route('PickWinner') }}" class="mt-0">
                            <button type="button"
                                class="border border-[var(--color)] px-3 py-2 my-5 mx-3 rounded-xl">မထည့်ပါ</button></a>
                        <button type="submit"
                            class="border border-[var(--color)] px-3 py-2 my-5 mx-3 rounded-xl disabled:bg-slate-200"
